    ...
    return (
        <div className="card h-100 p-0 radius-12">
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td className="text-center">
                                        <div className="d-flex justify-content-center">
                                            ...
                                            >
                                                <Icon icon="ri:qr-code-line" className="text-xl text-neutral-600" />
                                            </div>
                                        </div>
                                    </td>
                                    <td className="text-center">
            ...
            <Modal centered show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
                ...
                <Modal.Body>
                    <p className="text-secondary-light">Are you sure you want to delete this meeting? This action cannot be undone.</p>
                </Modal.Body>
                <Modal.Footer>
            ...
            {/* QR Code Modal */}
            <Modal centered show={showQRModal} onHide={() => setShowQRModal(false)} size="lg">
                <Modal.Header closeButton>
                            ...
                            <div className="bg-light p-4 rounded mb-3">
                                <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '250px' }}>
                                    <div className="bg-white p-4 rounded shadow-sm">
                                        <Icon icon="ri:qr-code-line" style={{ fontSize: '200px' }} className="text-neutral-600" />
                                    </div>
                                </div>
                            </div>
                            <div className="text-start">
                                <p className="mb-1"><strong>Chapter:</strong> {selectedMeeting.chapter}</p>
                                <p className="mb-1"><strong>Amount:</strong> ₹{selectedMeeting.amount}</p>
                                <p className="mb-1"><strong>Location:</strong> {selectedMeeting.location}</p>
                                <p className="mb-1"><strong>Start:</strong> {new Date(selectedMeeting.startDate).toLocaleString()}</p>
                                <p className="mb-0"><strong>End:</strong> {new Date(selectedMeeting.endDate).toLocaleString()}</p>
                            </div>
                        </>
                    )}
                </Modal.Body>
                <Modal.Footer>
                    ...
                    <Button variant="primary" style={{ backgroundColor: "#C4161C", borderColor: "#C4161C" }}>
