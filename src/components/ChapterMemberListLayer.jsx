...
const ChapterMemberListLayer = () => {
    ...
    const [reportData] = useState(Array.from({ length: 25 }).map((_, i) => ({
        ...
        companyName: ['Tech Solutions', 'Modern Designs', 'Creative House', 'Building Pro', 'Civil Works'][i % 5],
        category: ['IT Services', 'Interior Design', 'Digital Marketing', 'Construction', 'Architecture'][i % 5],
                    ...
                    <table className="table bordered-table sm-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style={{ color: "black", fontWeight: '600' }}>Company Name</th>
