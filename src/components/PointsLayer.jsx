            ...
            <div className="card h-100 p-0 radius-12 border-0 shadow-sm">
                <div className="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div className="d-flex align-items-center gap-2">
                        <div className="bg-primary-600 radius-2" style={{ width: '4px', height: '24px' }}></div>
                        <h5 className="text-secondary-light mb-0 fw-bold header-title">Point Management System</h5>
                    </div>
                </div>
                ...
                <Modal.Body className="pt-2">
                    ...
                    <div className="form-group mb-4">
                        ...
                        <div className="input-group input-group-lg shadow-sm">
                            <span className="input-group-text bg-white border-end-0 radius-start-12">
                                <Icon icon="solar:star-bold" className="text-warning" fontSize={24} />
                            </span>
                            <input
                                type="number"
                                className="form-control radius-end-12 border-start-0 ps-0 fw-bold text-center"
                                value={tempValue}
