...
const TestimonialsReportDetailedLayer = () => {
    ...
    // Static Dummy Data for Testimonials Report
    const [reportData] = useState(Array.from({ length: 25 }).map((_, i) => ({
        ...
        testimonial: i % 2 === 0 ? 'Highly professional and dedicated member.' : 'Excellent work delivered on time.',
        starRating: (i % 5) + 1,
                    ...
                    <table className="table bordered-table sm-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style={{ color: "black", fontWeight: '600' }}>Testimonials to</th>
                            ...
                            {currentData.length > 0 ? (
                                currentData.map((item) => (
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <div className="text-md mb-0 fw-normal text-secondary-light" style={{ maxWidth: '300px' }}>
                                                {item.testimonial}
                                            </div>
                                        </td>
                                        <td>
