...
const PowerDateReportLayer = () => {
    ...
    const [reportData] = useState(Array.from({ length: 25 }).map((_, i) => ({
        ...
        comments: i % 3 === 0 ? 'Interested in joining.' : 'Regular follow-up needed.',
                            ...
                            {currentData.length > 0 ? (
                                currentData.map((item) => (
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <span className={`badge radius-4 px-10 py-4 text-sm ${item.meetingStatus === 'Online' ? 'bg-info-focus text-info-600' : 'bg-success-focus text-success-main'
                                                }`}>
                                                {item.meetingStatus}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <span className={`badge radius-4 px-10 py-4 text-sm ${item.referralTemp === 'Hot' ? 'bg-danger-focus text-danger-main' :
                                                item.referralTemp === 'Warm' ? 'bg-warning-focus text-warning-main' :
